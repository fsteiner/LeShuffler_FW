...
/**
  ...
  */
#define W25Q_FLASH_SIZE                  			0x2000000 /* 256 MBits =>  32 MBytes  */
#define W25Q_PAGE_SIZE                   			    0x100 /* there are 131.072 (0x20000) pages of 256 Bytes each in total */
#define W25Q_SECTOR_SIZE              			       0x1000 /* 1 sector = 16 (0x10) pages
															   * there are 8.192 (0x2000) sectors of 4KB each in total */
...
#define W25Q_READ_SR3_CMD 							0x15U	/* read status-register 3 */
#define W25Q_WRITE_SR3_CMD 							0x11U	/* write status-register 3 (8.2.5) */

#define W25Q_READ_EXT_ADD_REG_CMD					0xC8U   /* read extended address register (8.2.6) */
...
HAL_StatusTypeDef W25Q64_Read_Ext_Add_Register(OSPI_HandleTypeDef* hospi, uint8_t* register_data);
