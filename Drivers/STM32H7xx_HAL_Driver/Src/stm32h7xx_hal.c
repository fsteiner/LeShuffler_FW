...
/**
  * @brief  Return the first word of the unique device identifier (ABOUT based on 96 bits)
  * @retval Device identifier
  */
...
/**
  * @brief  Return the second word of the unique device identifier (ABOUT based on 96 bits)
  * @retval Device identifier
  */
...
/**
  * @brief  Return the third word of the unique device identifier (ABOUT based on 96 bits)
  * @retval Device identifier
  */
