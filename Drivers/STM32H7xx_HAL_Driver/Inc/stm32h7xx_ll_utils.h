...
/**
  * @brief  Get Word0 of the unique device identifier (ABOUT based on 96 bits)
  * @retval ABOUT[31:0]
  */
...
/**
  * @brief  Get Word1 of the unique device identifier (ABOUT based on 96 bits)
  * @retval ABOUT[63:32]
  */
...
/**
  * @brief  Get Word2 of the unique device identifier (ABOUT based on 96 bits)
  * @retval ABOUT[95:64]
  */
